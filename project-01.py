...
def llama_generate_response(prompt):
    ...
    payload = {
        ...
        "prompt": prompt+"Answer in Thai. Answer briefly, no more than 15 words. The respondent is an agricultural academic who gives advice to farmers. The agricultural academic is a man who gives concise and friendly advice.",
        "stream": False
    }
    ...
    if response.status_code == 200:
        ...
        return "Ollama ตอบ :"+decoded_text
    else:
        # Handle errors
